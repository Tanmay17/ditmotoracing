 ...
 */
public class tracksFragment extends Fragment  implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bt =(Button) view.findViewById( R.id.but );
    ...
    public void onClick(View view) {
        Toast.makeText( getContext(), "VROOM VROOM!!! YOUR CAR IS WAITING...RULE THE TRACK",Toast.LENGTH_LONG).show();
    }
